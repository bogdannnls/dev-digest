...
const GRID_COLS = "140px 160px 90px 90px 90px 110px 100px 110px";

/** Co-located styles for RecentRunsTable. No `<table>` — the same CSS-grid
 *  list convention every other list in this codebase uses. */
export const s = {
  table: {
